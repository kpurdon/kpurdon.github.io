...
date: 2014-12-06 13:23:17 -0700
comments: true
categories: [python, development, timelapse, waybackmachine]
---

The [Wayback Machine](https://archive.org/web/) from the Internet Archive is a tool that allows you to view "captures" of websites from a specific time in the past. I have used this tool many times usually driven by curiosity and nostalgia for web design of the past.

Recently I found myself wanting to view a timelapse of Wayback Machine images. I assumed there was something out there that would easily let me do this but to my surprise there was not!
...
![reddit.com gif]({{root_url}}/images/reddit-waybacklapse.gif)
...
Now at this point I REALLY just wanted a fast solution. Creating a GIF from a series of images in Python is not to difficult but I had [imagemagick]() installed and ready to go. So I took the easy way out and shelled out to imagemagick.
